...
const userInfoStyles = "w-full md:w-2/5 md:max-w-md min-w-sm md:border-customGray-600 md:border-l md:border-solid p-10 pb-0 sm:px-20 sm:py-10 md:p-10 flex flex-col gap-3 text-left md:order-2";
...
const UserPage: FC = () => {
  ...
  return <div className={containerStyles}>
    ...
    <div className={mainContentStyles}>
      <RepositoriesSection username={userId}/>
    </div>
  </div>
};
